...
const AddProduct = () => {
    ...
    const onSubmit = async (data) => {
        await fetch("https://hidden-ravine-16154.herokuapp.com/tools", {
            method: "POST",
            headers: {
                        ...
                        <div className='card p-8 text-left bg-base-300 rounded-2xl'>
                            <div className=''>
                                ...
                                <input
                                    ...
                                    type='text'
                                    class='input w-full font-bold border border-dark'
                                ></input>
                            ...
                            <div className=''>
                                ...
                                <textarea
                                    ...
                                    type='text'
                                    class='input w-full font-bold border border-dark h-28'
                                ></textarea>
                                <label className='text-error pt-1'>
                            ...
                            <div>
                                <button type='submit' className='btn btn-light text-black bg-base-200 text-bold mt-10 w-full text-xl'>
                                    {" "}
                                    Add Product{" "}
                                </button>
                            </div>
